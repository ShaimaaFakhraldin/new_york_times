...
import 'package:new_york_times/src/core/helper/helper.dart';
import 'package:new_york_times/src/core/router/router.dart';
import 'package:new_york_times/src/core/styles/app_theme.dart';
import 'package:new_york_times/src/core/translations/l10n.dart';
import 'package:new_york_times/src/core/utils/injections.dart';
import 'package:new_york_times/src/features/intro/presentation/pages/intro_page.dart';
import 'package:new_york_times/src/shared/data/data_sources/app_shared_prefs.dart';
...
class App extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, LanguageEnum newLocale) {
    ...
    getItInstance<AppSharedPrefs>().setLang(newLocale);
  }
}
